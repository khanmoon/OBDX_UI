define([
  ...
  "use strict";
  var userCreationLocale = function() {
    return {
      root: {
        userID: "User ID",
        ...
        trackMsgViaLink: "You can access your application via the ZigBank website in the Track Application section by providing your login details specified at the time of registration.",
        successMsg: "You have successfully registered with ZigBank and can now access our online banking services.",
        trackStatus: "Where can I track the status of my application ?",
        trackMsg1: "You can track your submitted application via the ZigBank website in the My Applications section.",
        ...
        savedAppMsg: "You can retrieve your saved application via the ZigBank website in the Track Application section.",
        ...
        saveAndComplete4: "You will need to register with us in order to track your application.Please provide the following details to register with ZigBank.",
        ...
        termsAndConditionsClickTitle: "Link to view terms and conditions",
        messages: {
