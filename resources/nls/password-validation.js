define([], function() {
  "use strict";
  var PasswordValidationLocale = function() {
    return {
      root: {
        passwordValidation: {
          messages: {
            ...
            showPasswordRule4: "Not contain consecutive (abc)characters more than {nbrConsecutive}",
            showPasswordRule8: "Not contain identical (aaa) characters more than {nbrIdentical}",
