define([
  ...
  return function(rootParams) {
    ...
    self.selectedMaturityOption = ko.observable("");
    self.termRequired = ko.observable(false);
    self.maturityDateLoaded = ko.observable(false);
    self.maturityDate = ko.observable();
    self.maturityTerm = ko.observable();
    self.termLoaded = ko.observable(false);
    self.maturityOption = [{
        id: "TERM"
      },
      {
    ...
    self.getRequirementModel = function(type) {
      if (!self.productDetails().requirements) {
        ...
        if (self.productDetails().requirements.requestedTenure) {
          ...
          self.productDetails().requirements.requestedTenure.days = ko.observable(ko.utils.unwrapObservable(self.productDetails().requirements.requestedTenure.days));
          ...
          self.productDetails().requirements.maturityDate = ko.observable(ko.utils.unwrapObservable(self.productDetails().requirements.maturityDate));
        }
      }
    };
    ...
    self.calculateLoanAmount = ko.computed(function() {
      ...
      if (self.productDetails().productClassName === "TERM_DEPOSITS") {
        if ((self.checkEmpty(self.productDetails().requirements.requestedAmount.amount()) && self.checkEmpty(self.productDetails().requirements.requestedTenure.years()) && self.checkEmpty(self.productDetails().requirements.requestedTenure.months()) && self.checkEmpty(self.productDetails().requirements.requestedTenure.days()) && self.productDetails().requirements.requestedAmount.amount() !== 0) || (self.productDetails().requirements.requestedAmount.amount() !== 0 && self.checkEmpty(self.productDetails().requirements.maturityDate()))) {
    ...
    self.changeFrqLoaded = function() {
      ...
      self.productDetails().requirements.maturityFactor = self.selectedMaturityOption();
      if (self.selectedMaturityOption() === "TERM") {
        if (!isNaN(self.productDetails().requirements.requestedTenure.years()) && !isNaN(self.productDetails().requirements.requestedTenure.months()) && !isNaN(self.productDetails().requirements.requestedTenure.days()) && !isNaN(self.productDetails().requirements.requestedAmount.amount())) {
          ...
          RequirementsModel.fetchMaturityPeriod(self.productDetails().submissionId.value, self.productDetails()).done(function(data) {
            self.maturityDateLoaded(true);
            self.maturityDate(data.termParameterDTO.maturityDate);
            self.productDetails().requirements.maturityDate(data.termParameterDTO.maturityDate);
          });
        }
      }
      if (self.selectedMaturityOption() === "MATURITY_DATE") {
        if (!isNaN(self.productDetails().requirements.requestedAmount.amount()) && self.productDetails().requirements.maturityDate() !== null) {
          RequirementsModel.fetchFrequencyList(self.productDetails().submissionId.value, self.productDetails()).done(function(data) {
            if (data.frequencies) {
              self.repaymentFrequencyData(data.frequencies);
              self.frequencyOptionsLoaded(true);
          ...
          RequirementsModel.fetchMaturityPeriod(self.productDetails().submissionId.value, self.productDetails()).done(function(data) {
            self.termLoaded(true);
            self.maturityTerm(data.termParameterDTO.depositTerm);
            self.productDetails().requirements.requestedTenure.days(data.termParameterDTO.depositTerm.days);
            self.productDetails().requirements.requestedTenure.months(data.termParameterDTO.depositTerm.months);
            self.productDetails().requirements.requestedTenure.years(data.termParameterDTO.depositTerm.years);
          });
        }
      }
    };
    ...
    self.submitRequirements = function() {
      ...
      if (!requirementsTracker || requirementsTracker.valid === "valid") {
        ...
        if (self.productDetails().requirements.requestedTenure) {
          self.productDetails().requirements.requestedTenure.days(self.productDetails().requirements.requestedTenure.days());
    ...
    self.setDefault = function() {
      self.maturityDate("");
      self.productDetails().requirements.maturityDate("");
      self.maturityTerm("");
      self.productDetails().requirements.requestedTenure.days("");
      self.productDetails().requirements.requestedTenure.months("");
      self.productDetails().requirements.requestedTenure.years("");
      self.productDetails().requirements.frequency("");
    };
