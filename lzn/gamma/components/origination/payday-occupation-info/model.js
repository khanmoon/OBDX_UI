define([
  ...
  return function OccupationInfoModel() {
    ...
    var Model = function(modelData) {
      ...
      updateModelDeferred,
      updateModel = function(model, profileId, deferred) {
        modelStateChanged = true;
        var params = {
            submissionId: submissionId,
            applicantId: applicantId,
      ...
      saveContactModelDeferred, saveContactModel = function(contactModel, deferred) {
        modelStateChanged = true;
        var params = {
            submissionId: submissionId,
            applicantId: applicantId
      ...
      updateContactModelDeferred, updateContactModel = function(contactModel, deferred) {
        modelStateChanged = true;
        var params = {
            submissionId: submissionId,
            applicantId: applicantId,
