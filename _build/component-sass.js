...
if (isDevMode) {
    ...
    glob(["../components/**/*.scss", "../framework/elements/**/*.scss", "../lzn/**/*.scss", "../extensions/**/*.scss"]).then(collateInputOutput).then(() => {
...
module.exports = function(grunt, filePath) {
    ...
    grunt.registerTask("compileSCSS", "Component CSS", function() {
        var done = this.async();
        glob(["../components/**/*.scss", "../framework/elements/**/*.scss", "../lzn/**/*.scss", "../extensions/**/*.scss"]).then(files => {
