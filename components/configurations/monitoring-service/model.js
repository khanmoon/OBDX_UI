define([
  ...
  "use strict";
  /**
   * Main file for DMSConfiguration Model. This file contains the model definition
   ...
   *          <ul>
   *              <li>[init()]{@link DMSConfigurationModel.init}</li>
   *              <li>[getPropertiesList()]{@link DMSConfigurationModel.getPropertiesList}</li>
   *              <li>[getProperty()]{@link DMSConfigurationModel.getProperty}</li>
   *              <li>[updateProperty()]{@link DMSConfigurationModel.updateProperty}</li>
   *              <li>[addProperty()]{@link DMSConfigurationModel.addProperty}</li>
   *              <li>[deleteProperty()]{@link DMSConfigurationModel.deleteProperty}</li>
   *              <li>[getFilteredProperties()]{@link DMSConfigurationModel.getFilteredProperties}</li>
   *          </ul>
   *      </li>
   * </ul>
   *
   * @namespace Categories~DMSConfigurationModel
   * @class DMSConfigurationModel
   */
  var DMSConfigurationModel = function() {
    var baseService = BaseService.getInstance(),
       ...
       * @memberOf DMSConfigurationModel
       * @private
       *
      ...
      getPropertiesList = function(categoryId, deferred) {
        var option = {
            url: "configurations/dms/{configurationId}/properties",
      ...
      getProperty = function(categoryId, propertyId, deferred) {
        var option = {
            url: "configurations/dms/{configurationId}/properties/{propertyId}",
            success: function(data) {
              deferred.resolve(data);
            }
          },
      ...
      getFilteredProperties = function(categoryId, filterText, deferred) {
        var option = {
            url: "configurations/dms/{configurationId}/properties?propertyId={propertyId}",
            success: function(data) {
              deferred.resolve(data);
            },
            error: function(data) {
    ...
    return {
       ...
       * @example
       *      DMSConfigurationModel.getPropertiesList().then(function (data) {
       *
       *      });
       */
       ...
       * @returns deferredObject
       * @example
       *      DMSConfigurationModel.getProperty().then(function (data) {
       *
       *      });
       */
       ...
       * @returns deferredObject
       * @example
       *      DMSConfigurationModel.updateProperty().then(function (data) {
       *
       *      });
       */
       ...
       * @returns deferredObject
       * @example
       *      DMSConfigurationModel.addProperty().then(function (data) {
       *
       *      });
       */
       ...
       * @returns deferredObject
       * @example
       *      DMSConfigurationModel.getFilteredProperties().then(function (data) {
       *
       *      });
       */
  ...
  return new DMSConfigurationModel();
});