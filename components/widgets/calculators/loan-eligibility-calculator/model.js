define(["baseService", "jquery", "framework/js/constants/constants"], function (BaseService, $, Constants) {
   ...
   */
  var LoanEligibilityModel = function () {
    /**
     ...
     */
    var fetchLocalCurrencyDeferred, calculateAmountDeferred, fetchCalculatorRangeDeferred, fetchLoanEligibility = function (dataToBeSent, deferred) {
        var options = {
      ...
      fetchLocalCurrency = function (deferred) {
        ...
        if (Constants.userSegment === "ADMIN") {
          options.url = "design-dashboard/data/calculators/loan-eligibility-calculator";
