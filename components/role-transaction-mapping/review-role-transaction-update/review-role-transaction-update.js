define([
...
], function(oj, ko, $, BaseLogger, RoleTransactionUpdateReviewModel, resourceBundle) {
  "use strict";
  return function(rootParams) {
    ...
    if (self.transactionDetails !== undefined) {
      ...
      self.userSegment = ko.observable(self.transactionDetails().transactionSnapshot.applicationRoleDTO.enterpriseRole);
      self.accessType = ko.observable(self.transactionDetails().transactionSnapshot.applicationRoleDTO.accessPointType === "INT" ? self.nls.common.menu.internal : self.nls.common.menu.external);
      self.selectedModuleName = ko.observable(self.transactionDetails().transactionSnapshot.modules);
