define([
  ...
  var approvalsRulesModel = function() {
    ...
    var createRulesDeferred, createRules = function(rulesCreatePayload, deferred) {
      ...
      getAccountListDeferred, getAccountList = function(partyID, deferred) {
        var options = {
      ...
      getTransactionRulesDeferred, getTransactionRules = function(taskType, deferred) {
        var options = {
    ...
    return {
      ...
      getAccountList: function(partyId) {
        ...
        getAccountList(partyId, getAccountListDeferred);
        return getAccountListDeferred;
      },
      getTransactionRules: function(taskType) {
        getTransactionRulesDeferred = $.Deferred();
        getTransactionRules(taskType, getTransactionRulesDeferred);
        return getTransactionRulesDeferred;
      },
