define([
  ...
  return function(rootParams) {
    ...
    self.afterRender = function(genericViewModel) {
      ...
      if (genericViewModel.queryMap.menuNavigationAvailable) {
        self.menuNavigationAvailable = genericViewModel.queryMap.menuNavigationAvailable === "true";
      } else {
    ...
    self.onLogin = function(genericViewModel) {
      ...
      if (Constants.authenticator === "OBDXAuthenticator") {
        ...
        loginOAM("@@OAM_BASE_URL/auth_cred_submit", {
