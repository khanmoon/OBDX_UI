define([
    ...
    return function viewModel(rootParams) {
        ...
        self.finalPayload = { linkedPartyAccountAccessDTOs: "" };
        ...
        self.relatedPartyId = ko.observable(rootParams.rootModel.linkedPartyId());
        self.relatedPartyName = ko.observable(rootParams.rootModel.linkedpartyName());
        ...
        self.createAccess = function () {
            ...
            ExclusionModel.createAccessClone(ko.toJSON(self.finalPayload), self.party.value(), self.relatedPartyId().value).done(function (data, status, jqXhr) {
        ...
        self.updateAccess = function () {
            ...
            self.finalPayLoadArray.push(self.getTDPayload());
            self.finalPayload.linkedPartyAccountAccessDTOs = self.finalPayLoadArray();
            ExclusionModel.updateAccessClone(ko.toJSON(self.finalPayload), self.party.value(), self.relatedPartyId().value).done(function (data, status, jqXhr) {
        ...
        self.readAccess = function () {
            ...
            ExclusionModel.readAccess(self.party.value(), self.relatedPartyId().value).done(function (data) {
                ...
                if (data.linkedPartyAccountAccessDTOs !== undefined) {
                    for (var i = 0; i < data.linkedPartyAccountAccessDTOs.length; i++) {
        ...
        self.deleteAccess = function () {
            ...
            self.finalPayLoadArray.push(self.getTDPayload());
            self.finalPayload.linkedPartyAccountAccessDTOs = self.finalPayLoadArray();
            ExclusionModel.deleteAccess(ko.toJSON(self.finalPayload), self.party.value(), self.relatedPartyId().value).done(function (data, status, jqXhr) {
                self.showDeleteButton(true);
                self.httpStatus(jqXhr.status);
                self.transactionStatus(data);
                self.showConfirmationForCreate(true);
